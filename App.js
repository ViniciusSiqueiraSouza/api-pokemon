  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        <Button title="Sortear Pokemon 1" onPress={() => sortearIdPokemon1()} />
        <Button title="Sortear Pokemon 2" onPress={() => sortearIdPokemon2()} />
...
const styles = StyleSheet.create({
  ...
  topoTitulo: { fontSize: 22, marginBottom: 10, color: '#1BDE3B', textAlign: 'center' },
